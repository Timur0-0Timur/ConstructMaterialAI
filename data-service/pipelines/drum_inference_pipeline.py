...
class DrumInferencePipeline(BaseETLPipeline):
    ...
    def transform(self, df_features: pd.DataFrame, df_weight: None) -> pd.DataFrame:
        ...
        # дропаем колонку количества индентичных
        df_merge = df_merge.drop(columns=raw['ident_number'], errors='ignore')
    ...
    def load(self, df: pd.DataFrame):
        ...
        super().load(df, filename='drum_dataset_inference.csv')

if __name__ == "__main__":
    drum_inference_config = config['equipment']['drum_inference']
